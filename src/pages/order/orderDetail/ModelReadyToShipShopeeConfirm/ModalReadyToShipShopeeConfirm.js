...
import './ModelReadyToShipShopeeConfirm.sass'
...
class ModalReadyToShipShopeeConfirm extends Component {
        ...
        return (
            <>
                {this.state.isFetching ?
                    <LoadingScreen/>
                    :
                    <Modal isOpen={this.state.isOpen} className="ready-to-ship-confirm-shopee">
                        ...
                        <ModalBody>
                            ...
                            <>
                                <div className="ready-to-ship-confirm__message">
                                    <Trans i18nKey="page.order.detail.readyToShip.message.shopee"/>
                                </div>
                            </>
                            }
                        </ModalBody>
...
ModalReadyToShipShopeeConfirm.propTypes = {
...
export default ModalReadyToShipShopeeConfirm;
