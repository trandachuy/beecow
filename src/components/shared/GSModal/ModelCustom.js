...
class ModalCustom extends React.Component {
    ...
    renderModalDialog() {
        ...
        return (
            <div
                {...attributes}
                className={mapToCssModules(classNames(this.props.className, {
...
ModalCustom.propTypes = propTypes;
ModalCustom.defaultProps = defaultProps;
ModalCustom.openCount = 0;
