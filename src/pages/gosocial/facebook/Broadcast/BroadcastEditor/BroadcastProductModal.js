...
import './BroadcastProductModal.sass'
...
class BroadcastProductModal extends Component {
    SIZE_PER_PAGE = 10
    ON_INPUT_DELAY = 500
    state = {
        // list for every page
                ...
                <Modal isOpen={this.state.isHasProduct && !this.state.isSearch} className="select-product-modal"
                    ...
                    <ModalBody>
                        <UikSelect
                            ...
                            defaultValue={this.state.selectedBranch?.value || 
                            (this.state.branches.length === 1 ? this.state.branches[0].value : this.state.branches.find(b => b.isDefault === true)?.value)
                            }
...
BroadcastProductModal.defaultProps = {
...
BroadcastProductModal.propTypes = {
...
export default BroadcastProductModal;
