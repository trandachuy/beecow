                        ...
                        <div className="contact-info__description">
                            ...
                            <h3>
                                <GSTrans i18nKey="page.setting.plans.step3.thanksForUsing" values={
                                    {
                                        provider: i18next.t("page.shopee.plans.step3.head.extension")
                                    }
                                }/>
                                <br/>
                            ...
                            <div className="details-container d-mobile-none d-desktop-flex">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td className="value">
                                            <Trans i18nKey="shopee.page.plans.step2.plan.title"/>
                                        </td>
                                        <td className="title">
...
export default ShopeePlansStep2;
