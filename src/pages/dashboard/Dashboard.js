...
class Dashboard extends Component {
    ...
    render() {
        return (
            <GSLayoutContentContainer className="dashboard" isLoading={this.state.isFetching} minWidthFitContent>
                <GSLayoutContentHeader title={i18next.t("page.analytics.orders.title")}>
                ...
                <GSLayoutContentBody size={GSLayoutContentBody.size.MAX}>
                    ...
                    <GSLayoutRow marginTop marginBottom>
                        ...
                        <GSLayoutCol3>
                            <GSCard className="dashboard-ava-card">
                                <span className="card-title">
                                    {i18next.t("page.dashboard.totalProduct")}
                                </span>
                                <GSTooltip message={i18next.t("page.dashboard.totalProduct.toolTip")} icon={GSTooltipIcon.INFO_CIRCLE}/>
                                <UikAvatar
                                    highlighted
                                    imgUrl={"/assets/images/dashboard/total_product.svg"}
                        ...
                        <GSLayoutCol3>
                            <GSCard className="dashboard-ava-card">
                                <span className="card-title">
                                    {i18next.t("page.dashboard.soldQuantity")}
                                </span>
                                <GSTooltip message={i18next.t("page.dashboard.soldQuantity.toolTip")}  icon={GSTooltipIcon.INFO_CIRCLE}/>
                                <UikAvatar
                                    highlighted
                                    imgUrl={"/assets/images/dashboard/sold_quantity.svg"}
                        ...
                        <GSLayoutCol3>
                            <GSCard className="dashboard-ava-card">
                                <span className="card-title">
                                    {i18next.t("page.dashboard.avgOrderValue")}
                                </span>
                                <GSTooltip message={i18next.t("page.dashboard.avgOrderValue.toolTip")}  icon={GSTooltipIcon.INFO_CIRCLE}/>
                                <UikAvatar
                                    highlighted
                                    imgUrl={"/assets/images/dashboard/avg_order_value.svg"}
                        ...
                        <GSLayoutCol3>
                            <GSCard className="dashboard-ava-card">
                                <span className="card-title">
                                    {i18next.t("page.dashboard.pendingRevenue")}
                                </span>
                                <GSTooltip message={i18next.t("page.dashboard.pendingRevenue.toolTip")} icon={GSTooltipIcon.INFO_CIRCLE}/>
                                <UikAvatar
                                    highlighted
                    ...
                    <GSLayoutRow>
                        ...
                        {/*    <GSWidget>*/}
                        {/*        <GSWidgetHeader>*/}
                        {/*            <Trans i18nKey="page.dashboard.table.topProduct"/>*/}
                        {/*        </GSWidgetHeader>*/}
                        {/*        <GSWidgetContent>*/}
                        {/*            <UikWidgetTable>*/}
                        {/*                <thead>*/}
                        {/*                <tr>*/}
                        {/*                    <th>*/}
                        {/*                        <Trans i18nKey="page.dashboard.table.productName"/>*/}
                        {/*                    </th>*/}
                        {/*                    <th>*/}
                        {/*                        <Trans i18nKey="page.dashboard.table.quantity"/>*/}
                        {/*                    </th>*/}
                        {/*                    <th>*/}
                        {/*                        <Trans i18nKey="page.dashboard.table.growthRate"/>*/}
                        {/*                    </th>*/}
                        {/*                </tr>*/}
                        {/*                </thead>*/}
                        {/*                <tbody>*/}
                        {/*                {this.state.topProduct.map( (product, index) => {*/}
                        {/*                    return (*/}
                        {/*                        <tr key={index}>*/}
                        ...
                        <GSLayoutCol12>
                            <GSWidget>
                                <GSWidgetHeader>
                                    <Trans i18nKey="page.dashboard.table.recentOrders"/>
                                </GSWidgetHeader>
                                <GSWidgetContent>
                                    <UikWidgetTable>
                                        <thead>
                                        <tr>
                                            ...
                                            <th>
                                                <Trans i18nKey="page.dashboard.table.orderCode"/>
                                            </th>
                                            <th>
    ...
    fetchData(dateRange) {
        ...
        this.pmFetchData = beehiveService.getAnalyticsInfo(dateRange)
        this.pmFetchData
            .then( result => {
