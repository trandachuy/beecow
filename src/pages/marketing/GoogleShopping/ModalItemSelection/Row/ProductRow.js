...
import {SCREENS_ENUM} from "../ModalItemSelection";
...
const ProductRow = props => {
    ...
    const {product} = props
    return (
        <div className={["d-flex align-items-center product-list-barcode-printer-product-row py-2", props.screen === SCREENS_ENUM.SEARCH_RESULT? 'gsa-hover--gray cursor--pointer':''].join(' ')} onClick={onCheck}>
