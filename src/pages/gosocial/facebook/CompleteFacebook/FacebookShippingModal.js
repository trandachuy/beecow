...
const FacebookShippingModal = props => {
    ...
    const handleSubmitShipping = () => {
        ...
        dispatch(
            FbMessengerContext.actions.setShippingInfo({ amount: +(stTotalShippingModal) })
        );
...
FacebookShippingModal.defaultProps = {}

FacebookShippingModal.propTypes = {}

export default FacebookShippingModal