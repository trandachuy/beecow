                ...
                label={
                    <>
                        ...
                        <div className="segment-number">
                            <span><GSTrans t="page.marketing.discounts.coupons.customer_segment_modal.countUser" values={{total: CurrencyUtils.formatThousand(props.data.totalCustomer)}}/></span>
                        </div>
                    </>
                }
                name="rgroup"
