...
const ProductSearch = props => {
    ...
    const [posScannerState, setPosScannerState] = useRecoilState(OrderInFacebookRecoil.posScannerState)
    ...
    const onInputSearch = (event) => {
        ...
        dispatch(FbMessengerContext.actions.setSearchProductText(keyword))
    ...
    const isBottom = (el) => {
        const afterCal = Math.floor(el.scrollHeight - el.scrollTop);
    ...
    const selectProduct = (product) => {
        ...
        dispatch(FbMessengerContext.actions.addNewProduct(clonedProduct))
        // temp product list
