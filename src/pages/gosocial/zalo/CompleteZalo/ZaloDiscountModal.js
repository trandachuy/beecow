...
const ZaloDiscountModal = props => {
    ...
    const handleSubmitDiscount = () => {
        ...
        dispatch(
            OrderInZaloContext.actions.setDiscountInfo({ amount: +(stTotalDiscountModal),method:stIsPercentageAndValueModal
                        ...
                        <div className={stDropdownDiscount ? "dropdown-menu show" : "dropdown-menu"}>
                            ...
                            <div className="search">
                                <AvFieldCurrency
                                    ...
                                    validate={{
                                        ...(!stIsPercentageAndValueModal ? FormValidate.maxValue(100) : FormValidate.maxValueMoney(OrderInZaloContextService.calculateSubTotalPrice(state.productList))),
...
ZaloDiscountModal.defaultProps = {}

ZaloDiscountModal.propTypes = {}

export default ZaloDiscountModal