...
import './CallCenterPlansStep2.sass';
...
const CallCenterPlansStep2 = props => {
    ...
    return (
        <>
            <div className="call-center-plans-step2">
                {/*DESKTOP*/}
                        ...
                        <div className="payment-info">
                            <div className="payment-info__total-price gs-atm__flex-row--flex-start gs-atm__flex-align-items--center">
                                ...
                                <span className="payment-info__price">
                                    {console.log(props.billObj.currency)}
...
export default CallCenterPlansStep2;
