...
import './OrderInStorePurchaseCartPromotion.sass';
...
const OrderInStorePurchaseCartPromotion = props => {
    ...
    const onClickClearPromotion = () => {
        ...
        OrderInStorePurchaseContextService.dispatchUpdateProductList({...state, promotion: undefined}, dispatch, state.productList, storeBranch)
    ...
    return (
        <form onClick={e => e.preventDefault()}
              className={cn("order-in-store-purchase-cart-promotion", {
...
OrderInStorePurchaseCartPromotion.propTypes = {

};

export default OrderInStorePurchaseCartPromotion;
