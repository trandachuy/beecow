...
const BranchPlansStep2 = props => {
    ...
    return (
        <>
            <div className="branch-plans-step2">
                {/*DESKTOP*/}
                        ...
                        <div className="contact-info__description">
                            ...
                            <h3>
                                <GSTrans i18nKey="page.setting.plans.step3.thanksForUsing" values={
                                    {
                                        provider: i18next.t("page.branch.plans.step3.head.extension")
                                    }
                                }/>
                                <br/>
                            ...
                            <div className="details-container d-mobile-none d-desktop-flex">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td className="value">
                                            {props.billObj.renewExtension ?
                                                props.billObj.renewExtension
                                                // <Trans i18nKey="page.call.center.plans.step1.extensionWithName"
                                                //        values={{number: props.billObj.renewExtension}}/>
                                                : <Trans i18nKey="page.branch.plans.step3.head.extension"/>}
                                        </td>
                                        <td className="title">
                                            <GSTrans t="page.setting.plans.step3.duration"/>
                                        </td>
                            ...
                            <div className="details-container d-mobile-flex d-desktop-none">
                                ...
                                {/*SERVICE NAME*/}
                                {props.billObj.voicePrice && <div className="details-short-row">
                                        <span className="title">
                                             <GSTrans t="page.setting.plans.step3.serviceName"/>
                                        </span>
                                    <span className="value">
                            ...
                            <p>
                                {(props.billObj.paymentMethod === 'ATM' || props.billObj.paymentMethod === 'VISA' || props.billObj.paymentMethod === 'ZALO' || props.billObj.paymentMethod === 'MOMO')
...
export default BranchPlansStep2;
