        ...
        return (
            <div className="d-flex flex-column">
                ...
                <UikCheckbox
                    ...
                    className="select-collection-row header"
                    onClick={(e) => this.props.selectAllItemForAPage(e)}
                    label={
                        <>
                            <div className="header-img">
                                {i18next.t('page.orders.returnOrder.table.image')}
                            </div>
                            <div className="header-unit">
                                {i18next.t('component.product.addNew.unit.title')}
                            </div>
                            <div className='header-price'>
                                {i18next.t('page.orders.returnOrder.table.orderedPrice')}
                            </div>
                        </>
                    }
                    name="rgroup"
                ...
                <UikCheckbox
                    ...
                    label={
                        <>
                            ...
                            <img alt={this.props.data.itemName} className="product-image" src={ImageUtils.getImageFromImageModel(ImageUtils.mapImageUrlToImageModel(this.props.data.itemImage))}/>
                            }
                            ...
                            <div className='product-unit'>
                                <span>{this.props.data.conversionUnitName || '-'}</span>
                            </div>
