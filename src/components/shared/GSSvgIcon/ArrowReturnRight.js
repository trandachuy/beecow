...
const ArrowReturnRight = (props) => {
    return(
        <SvgIcon xmlns="http://www.w3.org/2000/svg" width={props.width} height={props.height} fill="currentColor" className='bi bi-arrow-return-right' viewBox={props.viewBox} {...props}>
...
export default React.memo(ArrowReturnRight);
