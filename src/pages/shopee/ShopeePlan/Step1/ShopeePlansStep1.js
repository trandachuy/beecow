                            ...
                            <tr>
                                ...
                                <td>
                                    <div className='calculate-pricing'>
                                        {CurrencyUtils.formatMoneyByCurrency(stShopeeAmount, stPackagePrices[0] ? stPackagePrices[0].currency : 'đ')}
                                    </div>
                                </td>
                                <td>
                    ...
                    <div className="plan-info__price-selector d-mobile-flex d-desktop-none">
                        ...
                        <div className="detail-block mb-0" hidden={!stUnusedExtPlan}>
                            <div hidden={!stUnusedExtPlan}>
                                ...
                                <span className={'font-bold'}>-{CurrencyUtils.formatMoneyByCurrency(stUnusedExtPlan, stPackagePrices[0] ? stPackagePrices[0].currency : 'đ')}</span>
                            </div>
                        </div>
