...
import {any, arrayOf, bool, func, number, oneOf, oneOfType, string} from "prop-types";
...
export default class DateTimeField extends Component {
  ...
  static propTypes = {
    ...
    viewMode: string,
    zIndex: number,
    size: oneOf([Constants.SIZE_SMALL, Constants.SIZE_MEDIUM, Constants.SIZE_LARGE]),
    daysOfWeekDisabled: arrayOf(number)
  }
  ...
  state = {
      ...
      buttonIcon: this.props.mode === Constants.MODE_TIME ? "fa-clock-o" : "calendar-alt",
      widgetStyle: {
        display: "block",
        position: "absolute",
        left: -9999,
    ...
    return (
          <div>
            ...
            <div className={"input-group date " + this.size()} ref="datetimepicker">
              ...
              }} onChange={this.onChange} type="text" value={this.state.inputValue} {...this.props.inputProps}/>
              <span className="input-group-addon" onBlur={this.onBlur} onClick={this.onClick} ref="dtpbutton">
                <FontAwesomeIcon className='fa-lg' icon={['far', this.state.buttonIcon]} style={{
                  position: 'absolute',
                  right: '1rem',
                  top: '.6rem',
                  color: '#939393',
